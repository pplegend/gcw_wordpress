...
function icraft_widgets_init() {
	...
	register_sidebar( array(
	 ...
	 register_sidebar(array(
		...
		'before_widget' => '<div class="widget">',
		'after_widget' => '</div>',
		'before_title' => '<h3><span>','after_title' => '</span></h3>',
		'id'           => 'hot-video',
		'description'  => "hottest videos",
	));
	 register_sidebar(array(
	    'name' => "teach videos",
		'before_widget' => '<div class="widget">',
...
register_post_type('videos', 
		    array('label' => __('Videos','templatic'),
			  ...
			  'rewrite' => array("slug" => "videos"), // Permalinks
					     ...
					     'supports' => array('title','author', 'excerpt','thumbnail','comments','editor', 
								'trackbacks','custom-fields','revisions') ,
