       ...
       <li class="<?php echo $oddcomment; ?> <?php if(function_exists("author_highlight")) author_highlight(); ?> comment wrap threaded" id="comment-<?php comment_ID() ?>">         
			...
			<div class="meta-left">
				...
				<div class="meta-wrap">
					...
					<?php echo get_avatar( $comment, 48, $template_path . ''.get_get_template_directory_uri().'/images/gravatar.png' ); ?><br />
    ...
    <?php else : ?>
        ...
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            ...
            <?php else : ?>
				...
				<label for="author"><small><?php echo get_option('ptthemes_comment_name_name'); ?> <?php if ($req) _e('*','templatic'); ?></small></label></p>

                <p class="commpadd"><input type="text" name="email" id="email" value="<?php echo $comment_auth_email; ?>" size="22" tabindex="2" />
				<label for="email"><small><?php echo get_option('ptthemes_comment_mail_name'); ?> <?php if ($req) _e('*','templatic'); ?></small></label></p>
