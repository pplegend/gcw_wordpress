    ...
    <?php else : ?>
        ...
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            ...
            <?php else : ?>
                ...
                <p class="commpadd">
				 <label for="author"><small><?php echo get_option('ptthemes_comment_name_name'); ?> <?php if ($req) _e('*','templatic'); ?></small></label> <input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" class="name" /></p>

                <p class="commpadd">
				<label for="email"><small><?php echo get_option('ptthemes_comment_mail_name'); ?> <?php if ($req) _e('*','templatic'); ?></small></label> <input type="text" name="email" id="email" value="<?php echo $comment_auth_email; ?>" size="22" tabindex="2" class="email" /> </p>

				<p class="commpadd">
			    <label for="url"><small><?php echo get_option('ptthemes_comment_website_name'); ?></small></label> <input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" class="website" /></p>
